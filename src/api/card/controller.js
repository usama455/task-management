...
import { errorResponse, responseMessage, responseStatus, successResponse } from "../../utils/response"
...
export const getAllCards = async (req, res) => {
    try {
      const cards = await Card.find()
        ...
        .select("title project assignedTo subTasks comments status updatedAt createdAt")
        .sort({ updatedAt: -1 });
